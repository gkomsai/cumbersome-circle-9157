...
const MobileNav = ({ onOpen, ...rest }: MobileProps) => {
  return (
    ...
    <Flex
      ...
      <Text fontSize="2xl" fontFamily="monospace" fontWeight="bold" marginLeft="25px">
        Clients
        </Text>
        <Box>
        <Client/>
      ...
      <Flex marginLeft="65%" >
      <Box>
      <Select placeholder='Group By:' border="solid 1px black" >
      ...
      <Box>
      <Select placeholder='Filter:' border="solid 1px black" >
